...
def generate_question(skill, proficiency):
    gemini_prompt_old = f'''
                    ...
                    Generate 100 questions in the form of an array containing 100 elements each being in the format [question,option_a,option_b,option_c,option_d,correct option(enum[a,b,c,d])].
    ...
    gemini_prompt = f'''
                    ...
                    Your task:
                    - Generate exactly 100 multiple-choice questions (MCQs) about the given skill.
                    ...
                    Format requirements:
                    - Output must be a **pure JSON array** of exactly 100 elements.
